...
void GPY211_WAN_SPEED()
{
	...
	eval("ethctl", "phy", "ext", EXTPHY_GPY_ADDR_STR, "0x1e0008", "0x24d9");
	eval("ethctl", "phy", "ext", EXTPHY_GPY_ADDR_STR, "0x0", "0x3240");

	_dprintf("[%s(%d)] GPY211 WAN war!\n", __FUNCTION__, __LINE__);
	logmessage("GPY211", "GPY211 WAN war!\n");
}
...
#if !defined(RTAX55) && !defined(RTAX1800) && !defined(RPAX56) && !defined(RPAX58) && !defined(RTAX58U_V2) && !defined(RTAX3000N)
	add_to_list("eth1", ifnames, sizeof(ifnames));
#endif
#if !defined(RTAX56_XD4) && !defined(XD4PRO) && !defined(CTAX56_XD4) && !defined(RTAX55) && !defined(RTAX1800) && !defined(RTAX82_XD6S) && !defined(RPAX56) && !defined(RPAX58) && !defined(RTAX58U_V2) && !defined(RTAX3000N)
	add_to_list("eth2", ifnames, sizeof(ifnames));
#endif
#if !defined(RTAX56_XD4) && !defined(XD4PRO) && !defined(CTAX56_XD4) && !defined(RTAX55) && !defined(RTAX1800) && !defined(RTAX82_XD6) && !defined(RTAX82_XD6S) && !defined(RPAX56) && !defined(RPAX58) && !defined(RTAX58U_V2) && !defined(RTAX3000N) && !defined(XC5)
	add_to_list("eth3", ifnames, sizeof(ifnames));
#endif
#if !defined(RTAX95Q) && !defined(XT8PRO) && !defined(BM68) && !defined(XT8_V2) && !defined(RTAXE95Q) && !defined(ET8PRO) && !defined(ET8_V2) && !defined(RTAX56_XD4) && !defined(XD4PRO) && !defined(CTAX56_XD4) && !defined(RTAX55) && !defined(RTAX1800) && !defined(RTAX82_XD6S) && !defined(RPAX56) && !defined(RPAX58) && !defined(RTAX58U_V2) && !defined(ET12) && !defined(XT12) && !defined(GT10) && !defined(RTAX3000N) && !defined(XC5)
...
#define LAN_PORTS 4
		...
		case MODEL_DSLAX82U:
		{
			...
			int ports[1] = { 0 };
#else // RTAX56U, RTAX55, RT-AX58U_V2, RT-AX3000N
...
#elif defined(RTAX55) || defined(RTAX58U_V2) || defined(RTAX3000N)
...
#endif
#if defined(RTAX58U) || defined(TUFAX3000) || defined(RTAX56U) || defined(RPAX56) || defined(RPAX58) || defined(DSL_AX82U) || defined(TUFAX3000_V2) || defined(RTAXE7800)
			setLANLedOn();
#endif
			break;
		}
...
void vlan_forwarding(int vid, int prio, int stb, int untag)
{
	...
	/* same vid case */
	if(stb == 6) {
#if defined(RTAX55) || defined(RTAX58U_V2) || defined(RTAX3000N)
		mask |= 1 << abs(3 - 4);
		mask |= 1 << abs(4 - 4);
#else
		mask |= 1 << (3 - 1);
...
{
#if defined(RTAX55) || defined(RTAX1800) || defined(RTAX58U_V2) || defined(RTAX3000N) //handle dualwan on rtkswitch
#ifdef RTCONFIG_DUALWAN
	int unit = 0;
	char wan_if[10];
	if (is_router_mode()) {
...
reset_psr_hwaddr()
{
	...
	if (model == MODEL_RTAX56U || model == MODEL_RPAX56 || model == MODEL_RPAX58 || model == MODEL_RTAX55 || model == MODEL_TUFAX3000_V2 || model == MODEL_RTAX3000N)
...
#if defined(RTCONFIG_BCM_MFG) && (defined(GT10) || defined(RTAX82U_V2))
...
void init_others(void)
{
	...
	update_cfe_675x();
#endif
#if defined(BCM6750) && !defined(RTAX82_XD6) && !defined(RTAX82_XD6S) && !defined(TUFAX5400) && !defined(RTAX82U_V2)
	update_cfe_ax58u();
#endif
	...
	setAllLedOn();
#endif
#if defined(RTAX58U_V2) || defined(TUFAX3000_V2)
...
#if defined(RTAX95Q) || defined(XT8PRO) || defined(GT10) || defined(XT12)
	/* wl2 */
...
_dprintf("*** Multicast IPTV: config Singtel TR069 on wan port ***\n");
	...
	case MODEL_XT12:
		...
		else if (model == MODEL_RTAX58U || model == MODEL_RTAX82U_V2) {
#ifdef RTAX82_XD6
			...
			if ((nvram_match("switch_wantag", "movistar") || 
				...
				*/
				if ((switch_stb <= 6)
					...
					if (model == MODEL_RTAX58U || model == MODEL_RTAX82_XD6S || model == MODEL_RTAX82U_V2)
		...
		if (nvram_match("switch_stb_x", "1") && nvram_match("switch_wantag", "none")) {
			...
			if (nvram_match("switch_wantag", "m1_fiber")
				...
				eval("vlanctl", "--if", wan_if, "--rx", "--tags", "1", "--set-rxif", wanVlanDev, "--filter-vid", vlan_entry, "0", "--filter-vlan-dev-mac-addr", "1", "--pop-tag", "--filter-vlan-dev-mac-addr", "1", "--rule-append");
				...
				eval("vlanctl", "--if", wan_if, "--rx", "--tags", "1", "--set-rxif", wanVlanDev1, "--filter-vid", vlan_entry, "0", "--pop-tag", "--filter-vlan-dev-mac-addr", "1", "--rule-append");
			...
			else if (model == MODEL_RTAX95Q || model == MODEL_XT8PRO || model == MODEL_BM68 || model == MODEL_XT8_V2 || model == MODEL_RTAXE95Q || model == MODEL_ET8PRO || model == MODEL_ET8_V2 || model == MODEL_GTAX6000 || model == MODEL_GTAX11000_PRO || model == MODEL_GTAXE16000 || model == MODEL_RTAX86U_PRO || model == MODEL_TUFAX3000_V2) {
			...
			if (nvram_match("switch_wantag", "singtel_mio")) {
				...
				else if (model == MODEL_RTAX95Q || model == MODEL_XT8PRO || model == MODEL_BM68 || model == MODEL_XT8_V2 || model == MODEL_RTAXE95Q || model == MODEL_ET8PRO || model == MODEL_ET8_V2 || model == MODEL_GTAX6000 || model == MODEL_GTAX11000_PRO || model == MODEL_GTAXE16000 || model == MODEL_RTAX86U_PRO || model == MODEL_GT10) {
				/* exclude ET12/XT12 due to GPY211 LAN port can't be iptv/voip port */
					sprintf(ethPort3, "eth2");
					sprintf(vlanDev3, "eth2.v0");
					sprintf(ethPort4, "eth3");
...
#if defined(RTAX55) || defined(RTAX1800) || defined(RTAX86U) || defined(TUFAX5400) || defined(GTAX6000) || defined(RTAX86U_PRO) || defined(RTAX3000N)
...
void smart_connect_realign_ifnames() {
	...
	if(smartconnect_selif > 0  && smartconnect_selif_x > 0 && smartconnect_selif != smartconnect_selif_x) {
		...
		nvram_set_int("smartconnect_selif", smartconnect_selif_x);
		gen_bcmbsd_def_policy(smartconnect_selif);
	}
