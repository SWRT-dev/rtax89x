...
#define _QCA_QMI_FRAMEWORK_AF_QIPCRTR_ 42
#if _QCA_QMI_FRAMEWORK_AF_QIPCRTR_ != AF_QIPCRTR
#error AF_QIPCRTR changed! Update AF_QIPCRTR in qca-qmi-framework/source/qrtr/lib/libqrtr.h and _QCA_QMI_FRAMEWORK_AF_QIPCRTR_ here!
#endif
