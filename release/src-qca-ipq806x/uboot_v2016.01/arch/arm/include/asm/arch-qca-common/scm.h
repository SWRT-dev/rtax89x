...
extern int qca_scm_auth_kernel(void *cmd_buf, size_t cmd_len);
extern int is_scm_sec_auth_available(u32 svc_id, u32 cmd_id);
extern int qca_scm_secure_authenticate(void *cmd_buf, size_t cmd_len);
