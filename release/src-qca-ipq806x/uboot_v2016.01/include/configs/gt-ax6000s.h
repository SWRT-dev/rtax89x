 ...
 */
#define SPFVER			8
#define CONFIG_MODEL		"GT-AX6000S"
...
#define CONFIG_BLVER		KV1C KV2C "11"
...
#define CONFIG_BOOTFILE		CONFIG_MODEL ".trx"		/* GT-AX6000S.trx */
 ...
 */
#define CONFIG_MAX_BL_BINARY_SIZE	0x2F0000			/* 3MiB - 64KiB */
