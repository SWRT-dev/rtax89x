...
gpio_func_data_t gmac0_gpio[] = {
	...
	/* GMAC2, RGMII 1.8V */
	{	.gpio = 27,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 28,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 29,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 30,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 31,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 32,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 51,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 52,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 59,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 60,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 61,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
	{	.gpio = 62,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_8MA,	},
#elif defined(CONFIG_SWITCH_RTL8370MB_PHY_QCA8033_X2)
	/* BRT-AC828 SR4 or above */
	{
		.gpio = 10,
		.func = 5,	/* 5 for MDIO 1 */
		.pull = GPIO_NO_PULL,
	...
	/* GPIO#27~#32, #51~#52, #59~#62 are not used. */
	{	.gpio = 27,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 28,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 29,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 30,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 31,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 32,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 51,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 52,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 59,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 60,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 61,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
	{	.gpio = 62,	.func = 2,	.pull = GPIO_NO_PULL,	.drvstr = GPIO_2MA,	.oe = GPIO_OE_DISABLE	},
#endif
};
...
board_ipq806x_params_t board_params[] = {
	...
	},
	{
		...
		.gmac_cfg = {
			gmac_board_cfg(0, 0, RGMII, 0, 0, 0,
				8, 2, 3, 4, 5, 6, 7, 8, 9),		/* GMAC0, RGMII,  LAN, RTL8370M-GR */
			gmac_board_cfg(1, 0, RGMII, 0, 0, 0,
				8, 2, 3, 4, 5, 6, 7, 8, 9),		/* GMAC1, RGMII2, LAN, RTL8370M-GR */
			gmac_board_cfg(2, 0, SGMII, 0, 0, 1, 1, 5),	/* GMAC2, SGMII1, WAN0, PHY_ID:5, QCA8033 */
			gmac_board_cfg(3, 0, SGMII, 0, 0, 1, 1, 4),	/* GMAC3, SGMII2, WAN1, PHY_ID:4, QCA8033 */
		},
#elif defined(CONFIG_SWITCH_RTL8370MB_PHY_QCA8033_X2)
		/* BRT-AC828 SR4 or above */
		.gmac_gpio_count = ARRAY_SIZE(gmac0_gpio),
		.gmac_gpio = gmac0_gpio,
		.gmac_cfg = {
			gmac_board_cfg(0, 0, RGMII, 0, 0, 1, 1, 5),	/* GMAC0, RGMII,  2.5V, WAN0, PHY_ID:5, QCA8033 */
			gmac_board_cfg(1, 0, SGMII, 0, 0, 0,
				8, 2, 3, 4, 5, 6, 7, 8, 9),		/* GMAC1, SGMII0, LAN, RTL8370MB */
			gmac_board_cfg(2, 0, SGMII, 0, 0, 0,
				8, 2, 3, 4, 5, 6, 7, 8, 9),		/* GMAC2, SGMII1, LAN, RTL8370MB */
			gmac_board_cfg(3, 0, SGMII, 0, 0, 1, 1, 4),	/* GMAC3, SGMII2, 1.8V, WAN1, PHY_ID:4, QCA8033 */
		},
...
#else
#error Define your own switch chip
#endif
#if defined(CONFIG_UART_GSBI2)
		.console_uart_cfg = &gsbi2_console_uart,
#elif defined(CONFIG_UART_GSBI4)
		.console_uart_cfg = &gsbi4_console_uart,
#else
#error Define your own UART
#endif
		.flashdesc = NAND_NOR,
