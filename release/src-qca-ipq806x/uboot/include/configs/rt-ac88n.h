...
#define CONFIG_REF_AP161
#if defined(CONFIG_REF_AP148_030) && defined(CONFIG_REF_AP161)
#error Only one reference board is accepted at same time
#elif defined(CONFIG_REF_AP148_030)
#elif defined(CONFIG_REF_AP161)
#else
#error Define reference board.
#endif
...
#define CONFIG_BOOTFILE		CONFIG_MODEL ".trx"		/* RT-AC88N.trx */
 ...
 * Factory
 */
#define RAMAC0_OFFSET	0x5006	/* 2G EEPROM */
#define RAMAC1_OFFSET	0x1006	/* 5G EEPROM */
