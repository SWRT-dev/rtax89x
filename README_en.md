...
3. Enter `git clone https://github.com/SWRT-dev/rtax89x` to download source code 
...
6. Then enter `cd ../rtax89x/release/src-qca-ipq806x` to enter folder

7. Enter `make rt-ax89u` to start compiling the firmware

8. The firmware is in rtax89x/release/src-qca-ipq806x/image
